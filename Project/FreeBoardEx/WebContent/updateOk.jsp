...
${cv }
 --%>
<jsp:useBean id="vo" class="kr.green.board.vo.FreeBoardVO"></jsp:useBean>
...
${vo }
 ...
 <%
 	...
 	case "insert":
 		...
 		break;
 	case "update":
 		count = FreeBoardServiceImpl.getInstance().update(vo);
 		break;
 	case "delete":
 		count = FreeBoardServiceImpl.getInstance().delete(vo);
 		break;
 	}

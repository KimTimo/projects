...
try{
	...
	PollVO vo = PollUtil.readPollVO(application.getRealPath("/poll.json")).get(idx);
%>
<!DOCTYPE html>
<html>
<head>
	...
	<table>
		...
		<tr>
			<td align="center">
				...
				<input type="button" onclick="location.href='pollResult.jsp?idx=<%=idx %>'" value="결과보기"/>
				<input type="button" onclick="location.href='list.jsp'" value="목록으로"/>
			</td>
		</tr>
	</table>
	</form>

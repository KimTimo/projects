...
<%
	...
	int week = calendar.get(Calendar.DAY_OF_WEEK)-1; // 1~7을 리턴 : 0~6으로 변경하기 위하여 -1을 한다. ==> 1일의 요일
	...
	<table>
		...
		<%
			for(int i=1;i<=lastday;i++){
				calendar.set(yy, mm-1, i); //날짜 변경
				week = calendar.get(Calendar.DAY_OF_WEEK)-1; // 요일
				if(week==0){ // 일요일이면

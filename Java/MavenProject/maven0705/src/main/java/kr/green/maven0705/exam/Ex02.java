...
public class Ex02 {
	...
	public void test() {
		Solution solution = new Solution();
		assertEquals(solution.solution(new int[] { 1, 3, 4, 5, 8, 2, 1, 4, 5, 9, 5 }, "right"), "LRLLLRLLRRL");
		assertEquals(solution.solution(new int[] { 7, 0, 8, 2, 8, 3, 1, 5, 7, 6, 2 }, "left"), "LRLLRRLLLRR");
		assertEquals(solution.solution(new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0 }, "right"), "LLRLLRLLRL");
	}
	...
	static class Solution {
		public String solution(int[] numbers, String hand) {
			...
			int keymap[][] = { { 3, 1 }, { 0, 0 }, { 0, 1 }, { 0, 2 }, { 1, 0 }, { 1, 1 }, { 1, 2 }, { 2, 0 }, { 2, 1 },
					{ 2, 2 } };

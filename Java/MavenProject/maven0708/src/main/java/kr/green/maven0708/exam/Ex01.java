package kr.green.maven0708.exam;
...
신규 아이디 추천
문제 설명
카카오에 입사한 신입 개발자 네오는 "카카오계정개발팀"에 배치되어, 카카오 서비스에 가입하는 유저들의 
아이디를 생성하는 업무를 담당하게 되었습니다. 
	...
	static class Solution {
	    public String solution(String new_id) {
	    	...
	    	for(String s : answer.split("")) {
	    		if("abcdefghijklmnopqrstuvwxyz01234567890-_.".contains(s)) t += s;
	    	}
	    	answer = t;
	    	// 3단계 new_id에서 마침표(.)가 2번 이상 연속된 부분을 하나의 마침표(.)로 치환합니다.
	    	t = answer.charAt(0)=='.' ? ".":"";

...
<body>
	...
	<%-- ${commVO } <br />  --%>
	<%
		// 서비스 클래스를 호출하여 리스트를 읽어온다.
		PagingVO<FileBoardVO> pv = FileBoardService.getInstance().selectList(cv);
		// request영역에 저장한다.
		...
		<tr>
			<td class="info" colspan="5">
				<button type="button" class="btn btn-outline-success btn-sm" 
			        onclick='SendPost("insert.jsp",{"p":${pv.currentPage },"s":${pv.pageSize },"b":${pv.blockSize }},"post")'>글쓰기</button>
			</td>
		</tr>
	</table>	
</body>

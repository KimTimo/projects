...
<script>
	$(function() {
		...
		// sendData2(<%=p%>); // 실행시 현재 페이지 요청해서 보이기
		sendData3(<%=p%>); // 실행시 현재 페이지 요청해서 보이기
	});
	...
	// Jquery로 변경해보자!!!!
	function sendData2(pageNo) {
		// getJSON함수 사용
		$.getJSON("hanjaList.jsp?p=" + pageNo, function(data){
			var txt=''
		...
		<nav>
			<ul class="pagination pagination-sm justify-content-center">
				...
				<li class="page-item"><a class="page-link"
					href="?p=<%=(p - 1) / 10 * 10%>" aria-label="Previous"> <span
				...
				%>
				<li class="page-item"><a class="page-link"
					href="?p=<%=(p - 1) / 10 * 10 + 11%>" aria-label="Next"> <span

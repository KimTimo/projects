...
<%
	...
	fileList.add("images/1.jpg");
	// fileList.add("images/2.jpg");
	fileList.add("images/3.png");
	fileList.add("files/pom.xml");
	fileList.add("files/빅데이터.hwp");
	// 3. 메일보내기
	boolean result = SendMail.mailSender(mailVO, path, fileList);

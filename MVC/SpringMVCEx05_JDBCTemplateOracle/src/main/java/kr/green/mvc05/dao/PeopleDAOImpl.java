...
import kr.green.mvc05.vo.PeopleMapper;
...
public class PeopleDAOImpl implements PeopleDAO{
	...
	public boolean createPerson(PeopleVO peopleVO) {
		...
		boolean result = jdbcTemplate.update("insert into people (id, name,age) values (people_idx_seq.nextval,?,?)", peopleVO.getName(), peopleVO.getAge())>0;

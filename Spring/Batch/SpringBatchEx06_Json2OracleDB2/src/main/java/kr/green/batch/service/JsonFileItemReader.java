...
public class JsonFileItemReader extends AbstractItemCountingItemStreamItemReader<LicenseVO> implements
			ResourceAwareItemReaderItemStream<LicenseVO>, InitializingBean{

	private Resource resource;
	private String classToBound;

	private List<LicenseVO> items;
	private int index =0;
	...
	@Override // 1개를 리턴
	protected LicenseVO doRead() throws Exception {
	...
	protected void doOpen() throws Exception {
		...
		items = gson.fromJson(isr, new TypeToken<List<LicenseVO>>() {}.getType());
	}

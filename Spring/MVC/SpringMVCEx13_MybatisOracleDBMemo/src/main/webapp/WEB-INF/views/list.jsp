	...
	<table>
		...
		<tr>
			...
			<select name="s" id="s" onchange="changePageSize();">
			    <option value="3" ${pv.pageSize==3 ? " selected='selected' " : "" }>03개씩보기</option>
			    <option value="5" ${pv.pageSize==5 ? " selected='selected' " : "" }>05개씩보기</option>
			    ...
			    <option value="50" ${pv.pageSize==50 ? " selected='selected' " : "" }>50개씩보기</option>
			</select>

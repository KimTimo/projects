...
<script type="text/javascript">
	$(function(){
	     ...
	     var calendar = new FullCalendar.Calendar(calendarEl, {
	          ...
	          // 초기 이벤트 지정
	          events : [
	        	  {'title':'고객1-컷팅','start':'2021-09-20T13:00'},
	        	  {'title':'고객1-염색','start':'2021-09-20T14:00'},
	        	  {'title':'주인-휴가','start':'2021-09-21T00:00','end':'2021-09-23T24:00'},
	        	  {
	        		    "_id": 2,
	        		    "title": "치과예약",
	        		    "description": "어쩌구 저쩌구 하하하",
	        		    "start": "2021-09-01T12:30",
	        		    "end": "2021-07-01T15:30",
	        		    "type": "카테고리1",
	        		    "username": "나연",
	     ...
	     // 이벤트(일정)를 삽입해보자
	     calendar.addEvent({'title':'고객2-예약','start':'2021-09-28','end':'2021-09-30'});
